...
Install `plotly` and `gapminder` packages for this example. Load `tidyverse` and `here`.

```{r}
#| label = "setup",
#| include = FALSE

pacman::p_load(plotly, tidyverse, gapminder, here, wesanderson)
...
```{r}
amzn = read_csv(here::here('Data', 'amzn_2005_2020.csv'), show_col_types = FALSE) |> 
